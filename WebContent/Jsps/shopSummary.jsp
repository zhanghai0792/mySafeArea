...
//加载所有的汽车统计
function loadShopSummary() {
	$.post("/mySafeArea/AreaSummary/shop",
	{
		timestamp:(new Date()).valueOf()
	},
	function(result){
		$('#datagrid_shopSumnmary').datagrid('loadData',{total:result.total,rows:result.datas});
	}
  ...
  <body class="easyui-layout">
	...
	<div data-options="region:'east',title:'帮助',collapsible:true,collapsed:true,width:250"
		style="padding:10px;">
		<%@include file="../inc/help/shopSummary.inc"%>
	</div>
	<div data-options="region:'center',title:'商铺统计信息'">
		<table class="easyui-datagrid" id="datagrid_shopSumnmary"
