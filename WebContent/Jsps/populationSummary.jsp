...
function loadPopulationSummary() {
	$.post("/mySafeArea/AreaSummary/resident",
	{
		timestamp:(new Date()).valueOf()
	},
	function(result){
		$('#datagrid_populationSumnmary').datagrid('loadData',{total:result.total,rows:result.datas});
	}
  ...
  <body class="easyui-layout">
	...
	<div data-options="region:'east',title:'帮助',collapsible:true,collapsed:true,width:250"
		style="padding:10px;">
		<%@include file="../inc/help/populationSummary.inc"%>
	</div>
	<div data-options="region:'center',title:'人口统计信息'">
		<table class="easyui-datagrid" id="datagrid_populationSumnmary"
