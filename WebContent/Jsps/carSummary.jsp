...
function loadCarSummary() {
	$.post("/mySafeArea/AreaSummary/car",
	{
		timestamp:(new Date()).valueOf()
	},
	function(result){
		$('#datagrid_carSumnmary').datagrid('loadData',{total:result.total,rows:result.datas});
	}
  ...
  <body class="easyui-layout">
	...
	<div data-options="region:'east',title:'帮助',collapsible:true,collapsed:true,width:250"
		style="padding:10px;">
		<%@include file="../inc/help/carSummary.inc"%>
	</div>
	<div data-options="region:'center',title:'车辆统计信息'">
		<table class="easyui-datagrid" id="datagrid_carSumnmary"
